...
class Biblioteca:
    def __init__(self):
        ...
        @self.web.route('/destroyUsuarios/<int:id>')
        def destroyUsuarios(id):
            ...
            if usuario:
                ...
                return f'Usuario con ID {id} no encontrado.'

        @self.web.route('/Añadir_Libro')
        def añadir_libro():
            return render_template('AñadirLibro.html')

        @self.web.route('/storeLibros', methods=['POST'])
        def strorageLibros():
        ...
        @self.web.route('/Registrar_nuevo_usuario')
        def registrar_usuario():
            return render_template('RegistrarUsuario.html')

        @self.web.route('/storeUsuarios', methods=['POST'])
        ...
        @self.web.route('/Usuarios')
        def usuario():
            usuarios = Usuarios.query.all()
            return render_template('Usuarios.html', usuarios=usuarios)

        @self.web.route('/devolver_libro', methods=['GET', 'POST'])
        def devolver_libro():
        ...
        @self.web.route('/libros_con_retraso')
        def libros_retraso():
            libros_con_retraso = []
            prestamos = Prestamos.query.all()
        ...
        @self.web.route('/Solicitar_prestamo')
        def prestamo_libro():
            return render_template('PrestamoLibro.html')

        @self.web.route('/prestamosulicitud', methods=['POST'])
        ...
        @self.web.route('/registros_de_biblioteca')
        def registro():
